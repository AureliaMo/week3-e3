...
I walked the last bit from Waedenswil bahnhof to the campus, and there were some steep parts on the way to Oerlikon, where i moved slower. Also, I stopped sometimes to check the directions and wait for my friends. 
...
# looks ok, i see my stops or slower parts represented with the segmentation
```
